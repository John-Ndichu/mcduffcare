  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold font-heading transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        rx: 'border-transparent bg-brand-red/10 text-brand-red font-bold uppercase tracking-wider',
        otc: 'border-transparent bg-emerald-100 text-emerald-700 font-bold uppercase tracking-wider',
        'new': 'border-transparent bg-brand-royal text-white',
